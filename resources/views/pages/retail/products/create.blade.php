    ...
    <div class="retail-form-container">
        <div class="retail-form-card">
            <div class="retail-form-header mb-4">
                <h1 class="retail-form-title">Add New Product</h1>
                <p class="retail-form-subtitle">Create a new retail product with photo and details</p>
            </div>
            ...
            <form method="POST" action="{{ route('retail.products.store') }}" enctype="multipart/form-data" class="retail-form">
                @csrf
